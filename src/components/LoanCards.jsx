...
export default function LoanCards() {
  ...
  const loans = [
    { id: "home-loan", path: "/home-loan", icon: "🏠", title: "Home Loan", desc: "Make your dream home a reality with competitive rates and flexible tenures up to 30 years.", color: "from-blue-500 to-cyan-500" },
    { id: "personal-loan", path: "/personal-loan", icon: "💼", title: "Personal Loan", desc: "Get instant funds for any personal need — medical, travel, wedding, or education.", color: "from-indigo-500 to-purple-500" },
    { id: "business-loan", path: "/business-loan", icon: "🏢", title: "Business Loan", desc: "Scale your business with collateral-free loans and quick disbursement for SMEs.", color: "from-emerald-500 to-teal-500" },
    { id: "car-loan", path: "/car-loan", icon: "🚗", title: "Car Loan", desc: "Drive your dream car home with easy EMIs and fast processing from top lenders.", color: "from-orange-500 to-amber-500" },
  ];
