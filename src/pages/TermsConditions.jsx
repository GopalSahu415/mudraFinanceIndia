  ...
  return (
    <div className="relative">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        {[
          ["1. Acceptance of Terms", "By using MudraFinanceIndia's services, you agree to be bound by these Terms and Conditions. If you do not agree, please do not use our services."],
          ["2. Nature of Service", "MudraFinanceIndia is a financial service intermediary and loan facilitation platform. We are NOT a bank, NBFC, or direct lender. We connect borrowers with lending institutions and earn referral fees."],
          ...
          ["5. Fees", "Our service is free for borrowers. We earn referral fees from lending partners. There are no hidden charges from MudraFinanceIndia for connecting you with lenders."],
          ["6. Limitation of Liability", "MudraFinanceIndia is not liable for any losses arising from loan rejections, interest rate changes, or lender decisions. We provide facilitation services only."],
