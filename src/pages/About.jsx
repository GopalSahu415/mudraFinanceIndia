  ...
  return (
    <div className="relative">
      <div className="bg-gradient-to-br from-slate-900 via-blue-950 to-indigo-950 pt-32 pb-20 px-4 text-center">
        <h1 className="text-4xl sm:text-5xl font-black text-white mb-4">About MudraFinanceIndia</h1>
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-16 space-y-16" ref={ref}>
        <div className={`grid lg:grid-cols-2 gap-10 items-center transition-all duration-700 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
          <div>
            ...
            <p className="text-slate-500 leading-relaxed mb-4">MudraFinanceIndia was founded with a simple yet powerful vision — to make quality financial assistance accessible to every Indian, regardless of their background or location.</p>
        ...
        <div className="text-center">
          ...
          <div className="bg-amber-50 border border-amber-200 rounded-2xl p-6 text-amber-800 text-sm leading-relaxed max-w-3xl mx-auto">
            MudraFinanceIndia is an <strong>independent financial service platform</strong> and is <strong>not associated with any government organization or scheme</strong>. We are not a direct lender. All loan products are offered by our partner banks and NBFCs. Loan approval is at the sole discretion of the respective lending institution.
          </div>
        </div>
      </div>
    </div>
